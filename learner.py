...
def sign_pdf(pdf_path, key_path, cert_path, image_path, password):
    """Signs a PDF with a visible signature on every page."""
    if not all([pdf, key_path, cert_path, image_path]):
        print("Skipping signing due to missing information or libraries.")
        return
...
class DataReader:
    """
    Reads data from the specified Excel format.
    - Automatically extracts the Subject Name from the header.
    - Adapts column names to the required internal structure.
    """
    COLUMN_MAPPING = {
    ...
    def _extract_subject_from_header(self, file_path):
        """Opens the workbook and reads the first few rows to find the subject."""
        try:
            ...
            for row in range(1, 6):
                ...
                if cell_value and isinstance(cell_value, str) and "Exam:" in cell_value:
                    # Logic: Find the text between the LAST slash and the first opening bracket '['
            ...
            print(f"Warning: Could not automatically detect subject name. Details: {e}")
            return None
...
# ==============================================================================
class DocxWriter:
    """Saves a Document object to a .docx file."""
...
class PdfWriter:
    ...
    def write(self, doc, output_filename, sign_info=None, format_choice=None):
        ...
        try:
            ...
            # Add a small delay to ensure the file is fully written before signing
            time.sleep(1) 
...
# ==============================================================================
# 6. FACTORIES (To select the right writer/formatter)
# ==============================================================================
...
# ==============================================================================
# 7. CONTROLLER (The main orchestrator)
# ==============================================================================
